...
/// <summary>Mints JWTs with the same Issuer/Audience/SigningKey as appsettings.Development.json
/// (which the test WebApplicationFactory loads), so tests can hit [Authorize]-protected
/// endpoints without needing a running auth-service.</summary>
